...
Shader "Amazing Assets/Advanced Dissolve/Particles/Standard Surface"
{
    Properties
    {
...
//Advanced Dissolve 
ADVANCED_DISSOLVE_INIT_UV(o, v.texcoords.xy, o.pos)
  return o;
}
...
float3 normalWS = float3(IN.tSpace0.z, IN.tSpace1.z, IN.tSpace2.z);
  ...
  float4 dissolveBase = 0;
        ...
        dissolveBase = tex2D(_MainTex, surfIN.texcoord.xy);
  ...
  float dissolveBlend = AdvancedDissolveAlbedoEmission(cutoutSource, dissolveBase, dissolveAlbedo, dissolveEmission, surfIN.texcoord.xy);
...
//Advanced Dissolve Keywords End/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Fallback "VertexLit"
    CustomEditor "AmazingAssets.AdvancedDissolve.Editor.StandardParticlesShaderGUI"
}
