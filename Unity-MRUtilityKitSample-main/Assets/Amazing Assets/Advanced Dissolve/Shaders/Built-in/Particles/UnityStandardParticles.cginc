...
void surf (Input IN, inout SurfaceOutputStandard o)
{
    ...
    #if defined(_ALPHATEST_ON) || defined(_ALPHABLEND_ON) || defined(_ALPHAPREMULTIPLY_ON) || defined(_ALPHAOVERLAY_ON)
    o.Alpha = albedo.a;
    #else
    o.Alpha = 1;
    #endif
    ...
    //Advanced Dissolve - moved to the main shader
...
void vertParticleUnlit (appdata_particles v, out VertexOutput o)
{
    ...
    ADVANCED_DISSOLVE_INIT_UV(o, v.texcoords.xy, o.vertex)
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  float4 dissolveBase = 0;
        ...
        dissolveBase = tex2D(_MainTex, IN.texcoord.xy);
  ...
  float dissolveBlend = AdvancedDissolveAlbedoEmission(cutoutSource, dissolveBase, dissolveAlbedo, dissolveEmission, IN.texcoord.xy);
...
//Advanced Dissolve/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #if defined(_EMISSION)
    half3 emission = readTexture (_EmissionMap, IN).rgb * _EmissionColor.rgb;
    #else
    half3 emission = 0;
    #endif
...
//Advanced Dissolve///////////
#if defined(_AD_STATE_ENABLED)
    result.rgb = lerp(result.rgb, dissolveAlbedo, dissolveBlend);
    emission.rgb = lerp(emission, dissolveEmission, dissolveBlend);
#endif


    result.rgb += emission * cameraFade * softParticlesFade;
