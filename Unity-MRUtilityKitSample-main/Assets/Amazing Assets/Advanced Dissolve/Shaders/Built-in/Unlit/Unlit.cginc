...
#ifndef ADVANCED_DISSOLVE_UNLIT_CGINC
#define ADVANCED_DISSOLVE_UNLIT_CGINC
...
//Advanced Dissolve/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	#if defined(_RIM)
		#ifdef _NORMALMAP
			float rimFresnel = 1 - saturate(dot (bumpNormal, normalize(i.viewDir.xyz) * face) + _RimBias);	
		#else
			float rimFresnel = 1 - saturate(dot (i.normal.xyz, normalize(i.viewDir.xyz) * face) + _RimBias);	
		#endif
