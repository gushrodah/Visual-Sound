...
Shader "Amazing Assets/Advanced Dissolve/Mobile/Particles/VertexLit Blended" {
Properties {
...
v2f vert (appdata IN) {
  ...
  //Advanced Dissolve 
   o.positionWS = mul(unity_ObjectToWorld, float4(IN.pos, 1)).xyz;
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  float4 dissolveBase = 0;
        ...
        //dissolveBase.rgb *= _Color.rgb;    // no _Color
  #endif
