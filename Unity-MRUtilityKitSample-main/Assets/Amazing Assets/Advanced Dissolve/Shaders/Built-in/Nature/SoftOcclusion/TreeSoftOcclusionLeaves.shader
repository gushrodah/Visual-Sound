...
Shader "Amazing Assets/Advanced Dissolve/Nature/Tree Soft Occlusion Leaves" 
{
    Properties 
    {
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  float4 dissolveBase = 0;
        ...
        dissolveBase = tex2D(_MainTex, input.uv);
  ...
  float dissolveBlend = AdvancedDissolveAlbedoEmission(cutoutSource, dissolveBase, dissolveAlbedo, dissolveEmission, input.uv.xy);
...
//Advanced Dissolve/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                //Advanced Dissolve
                  ...
                  #if defined(_AD_STATE_ENABLED)
                    AdvancedDissolveCalculateAlphaAndClip(cutoutSource, c.a, cutout);
                  #endif
...
//Advanced Dissolve/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                //Advanced Dissolve
                  ...
                  #if defined(_AD_STATE_ENABLED)
                    AdvancedDissolveCalculateAlphaAndClip(cutoutSource, texcol.a, cutout);
                  #endif
  
                  clip (texcol.a - cutout);   
