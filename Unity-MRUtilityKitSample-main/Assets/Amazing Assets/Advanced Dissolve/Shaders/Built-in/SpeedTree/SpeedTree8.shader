...
Shader "Amazing Assets/Advanced Dissolve/Nature/SpeedTree8"
{
    Properties
    {
...
//Advanced Dissolve////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ADVANCED_DISSOLVE_SETUP_CUTOUT_SOURCE_USING_WS(IN, dissolveBase, worldPos, float3(IN.tSpace0.z, IN.tSpace1.z, IN.tSpace2.z))
  AdvancedDissolveClip(cutoutSource);
...
//#include "Assets/Amazing Assets/Curved World/Shaders/Core/CurvedWorldTransform.cginc"
 ...
 #include "../Core/Shadow.cginc" 
    ...
    Fallback "VertexLit"
    CustomEditor "AmazingAssets.AdvancedDissolve.Editor.SpeedTree8ShaderGUI"
}
