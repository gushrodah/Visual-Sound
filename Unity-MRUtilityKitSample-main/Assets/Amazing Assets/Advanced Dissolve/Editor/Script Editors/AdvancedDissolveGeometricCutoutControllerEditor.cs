...
namespace AmazingAssets.AdvancedDissolve.Editor
{
    ...
    public class AdvancedDissolveGeometricCutoutControllerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.Space(5);
            AmazingAssets.AdvancedDissolve.Editor.AdvancedDissolveMaterialProperties.DrawGroupHeader("Cutout");
            ...
            GUILayout.Space(5);
            AmazingAssets.AdvancedDissolve.Editor.AdvancedDissolveMaterialProperties.DrawGroupHeader("Additional Settings");
                ...
                if (xyzSpace.intValue == (int)AdvancedDissolve.AdvancedDissolveProperties.Cutout.Geometric.XYZSpace.World)
                {
                    using (new EditorGUIHelper.EditorGUILayoutBeginHorizontal())
                    {
                        ...
                        if (xyzPivotPointTransform.objectReferenceValue == null)
                        {
                            ...
                            {
                                xyzPivotPointTransform.objectReferenceValue = EditorUtilities.CreateGeometricCutoutTargetObject(((AdvancedDissolveGeometricCutoutController)serializedObject.targetObject).transform, "Pivot Point", xyzPivotPointPosition.vector3Value, Quaternion.identity, Vector3.one, true);
                            }
                        }
                    }
            ...
            using (new EditorGUIHelper.EditorGUILayoutBeginVertical("Box"))
            {
                using (new EditorGUIHelper.EditorGUILayoutBeginHorizontal())
                {
                    ...
                    if (startPositionTransform.objectReferenceValue == null)
                    {
                        if (GUILayout.Button("Create", GUILayout.MaxWidth(70)))
                        {
                            startPositionTransform.objectReferenceValue = EditorUtilities.CreateGeometricCutoutTargetObject(((AdvancedDissolveGeometricCutoutController)serializedObject.targetObject).transform, "Target (" + index + ")", startPosition.vector3Value, Quaternion.FromToRotation(Vector3.up, normal.vector3Value), Vector3.one, true);
                        }
                    }
                }
            ...
            using (new EditorGUIHelper.EditorGUILayoutBeginVertical("Box"))
            {
                using (new EditorGUIHelper.EditorGUILayoutBeginHorizontal())
                {
                    ...
                    if (startPositionTransform.objectReferenceValue == null)
                    {
                        if (GUILayout.Button("Create", GUILayout.MaxWidth(70)))
                        {
                            startPositionTransform.objectReferenceValue = EditorUtilities.CreateGeometricCutoutTargetObject(((AdvancedDissolveGeometricCutoutController)serializedObject.targetObject).transform, "Target (" + index + ")", startPosition.vector3Value, Quaternion.identity, Vector3.one, true);
                        }
                    }
                }
            ...
            using (new EditorGUIHelper.EditorGUILayoutBeginVertical("Box"))
            {
                using (new EditorGUIHelper.EditorGUILayoutBeginHorizontal())
                {
                    ...
                    if (startPositionTransform.objectReferenceValue == null)
                    {
                        if (GUILayout.Button("Create", GUILayout.MaxWidth(70)))
                        {
                            startPositionTransform.objectReferenceValue = EditorUtilities.CreateGeometricCutoutTargetObject(((AdvancedDissolveGeometricCutoutController)serializedObject.targetObject).transform, "Target (" + index + ")", startPosition.vector3Value, Quaternion.Euler(rotation.vector3Value), size.vector3Value, true);
                        }
                    }
                }
            ...
            using (new EditorGUIHelper.EditorGUILayoutBeginVertical("Box"))
            {
                ...
                using (new EditorGUIHelper.EditorGUILayoutBeginHorizontal())
                {
                    ...
                    if (startPositionTransform.objectReferenceValue == null)
                    {
                        if (GUILayout.Button("Create", GUILayout.MaxWidth(70)))
                        {
                            startPositionTransform.objectReferenceValue = EditorUtilities.CreateGeometricCutoutTargetObject(((AdvancedDissolveGeometricCutoutController)serializedObject.targetObject).transform, "Target (" + index + ") Start", startPosition.vector3Value, Quaternion.identity, Vector3.one, true);
                        }
                    }
                }
                ...
                using (new EditorGUIHelper.EditorGUILayoutBeginHorizontal())
                {
                    ...
                    if (endPositionTransform.objectReferenceValue == null)
                    {
                        if (GUILayout.Button("Create", GUILayout.MaxWidth(70)))
                        {
                            endPositionTransform.objectReferenceValue = EditorUtilities.CreateGeometricCutoutTargetObject(((AdvancedDissolveGeometricCutoutController)serializedObject.targetObject).transform, "Target (" + index + ") End", endPosition.vector3Value, Quaternion.identity, Vector3.one, true);
                        }
                    }
                }
