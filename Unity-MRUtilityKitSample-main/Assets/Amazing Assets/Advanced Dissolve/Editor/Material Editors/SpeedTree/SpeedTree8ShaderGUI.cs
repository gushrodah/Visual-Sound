...
namespace AmazingAssets.AdvancedDissolve.Editor
{
    class SpeedTree8ShaderGUI : ShaderGUI
    {
        ...
        private static void MakeAlignedProperty(MaterialProperty prop, GUIContent text, UnityEditor.MaterialEditor materialEditor, bool doubleWide = false)
        {
        ...
        private static void MakeCheckedProperty(MaterialProperty keywordToggleProp, MaterialProperty prop, GUIContent text, UnityEditor.MaterialEditor materialEditor, bool doubleWide = false)
        {
            Rect position = EditorGUILayout.GetControlRect(true, UnityEditor.EditorGUIUtility.singleLineHeight + 2f, new GUILayoutOption[0]);
        ...
        public override void OnGUI(UnityEditor.MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            AmazingAssets.AdvancedDissolve.Editor.AdvancedDissolveMaterialProperties.DrawCurvedWorldHeader(true, GUIStyle.none, materialEditor, (Material)materialEditor.target);
