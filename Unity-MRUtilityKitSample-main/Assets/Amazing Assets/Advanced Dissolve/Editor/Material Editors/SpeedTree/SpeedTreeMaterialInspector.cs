...
namespace AmazingAssets.AdvancedDissolve.Editor
{
    ...
    public class SpeedTreeMaterialInspector : ShaderGUI
    {
        ...
        public override void OnGUI(UnityEditor.MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            //Curved World
            AdvancedDissolveMaterialProperties.DrawCurvedWorldHeader(true, GUIStyle.none, materialEditor, (Material)materialEditor.target);



            if (AdvancedDissolveMaterialProperties.DrawDefaultOptionsHeader("Default Shader Options"))
            {
            ...
            //AmazingAssets
            AdvancedDissolveMaterialProperties.DrawDissolveOptions(true, materialEditor, false, false, true, true, false, false);
        }
